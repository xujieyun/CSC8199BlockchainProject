 ...
 **/
@WebServlet("/DeCreateSig")
public class DeCreateSig extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { Key key = null;
        ...
        String privateKey1=request.getParameter("privateKey1");
        String privateKey2=request.getParameter("privateKey2");
        String privateKey3=request.getParameter("privateKey3");
        String privateKey4=request.getParameter("privateKey4");
        String privateKeyTotal=privateKey1+privateKey2+privateKey3+privateKey4;
        String messageEn1=request.getParameter("messageEn1");
        String messageEn2=request.getParameter("messageEn2");
        String messageEnTotal=messageEn1+messageEn2;
        System.out.println(messageEnTotal + "\t加密后的字符串为:" + messageEnTotal);
        String messageDe = null;
        try {
            messageDe = decrypt(messageEnTotal,privateKeyTotal);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        response.getWriter().print(messageDe);
    }
